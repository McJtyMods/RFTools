...
import com.mcjty.rftools.blocks.environmental.modules.HasteEModule;
...
public class HasteEModuleItem extends Item implements EnvModuleProvider {
    ...
    public void addInformation(ItemStack itemStack, EntityPlayer player, List list, boolean whatIsThis) {
        ...
        list.add(EnumChatFormatting.GREEN + "Uses " + HasteEModule.RFPERTICK + " RF/tick (per cubic block)");
    }
