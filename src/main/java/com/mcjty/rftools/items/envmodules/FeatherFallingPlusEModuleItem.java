...
import com.mcjty.rftools.blocks.environmental.modules.FeatherFallingPlusEModule;
...
public class FeatherFallingPlusEModuleItem extends Item implements EnvModuleProvider {
    ...
    public void addInformation(ItemStack itemStack, EntityPlayer player, List list, boolean whatIsThis) {
        ...
        list.add(EnumChatFormatting.GREEN + "Uses " + FeatherFallingPlusEModule.RFPERTICK + " RF/tick (per cubic block)");
    }
