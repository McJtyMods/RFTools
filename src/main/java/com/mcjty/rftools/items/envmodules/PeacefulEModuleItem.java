...
import com.mcjty.rftools.blocks.environmental.modules.PeacefulEModule;
...
public class PeacefulEModuleItem extends Item implements EnvModuleProvider {
    ...
    public void addInformation(ItemStack itemStack, EntityPlayer player, List list, boolean whatIsThis) {
        ...
        list.add(EnumChatFormatting.GREEN + "Uses " + PeacefulEModule.RFPERTICK + " RF/tick (per cubic block)");
    }
