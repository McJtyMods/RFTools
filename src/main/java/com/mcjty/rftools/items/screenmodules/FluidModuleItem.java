...
import com.mcjty.rftools.blocks.screens.modules.FluidBarScreenModule;
...
import com.mcjty.rftools.blocks.screens.modulesclient.FluidBarClientScreenModule;
...
public class FluidModuleItem extends Item implements ModuleProvider {
    ...
    public void addInformation(ItemStack itemStack, EntityPlayer player, List list, boolean whatIsThis) {
        ...
        list.add(EnumChatFormatting.GREEN + "Uses " + FluidBarScreenModule.RFPERTICK + " RF/tick");
