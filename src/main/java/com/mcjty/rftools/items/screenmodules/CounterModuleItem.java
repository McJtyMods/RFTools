...
import com.mcjty.rftools.blocks.screens.modules.CounterScreenModule;
...
import com.mcjty.rftools.blocks.screens.modulesclient.CounterClientScreenModule;
...
public class CounterModuleItem extends Item implements ModuleProvider {
    ...
    public void addInformation(ItemStack itemStack, EntityPlayer player, List list, boolean whatIsThis) {
        ...
        list.add(EnumChatFormatting.GREEN + "Uses " + CounterScreenModule.RFPERTICK + " RF/tick");
