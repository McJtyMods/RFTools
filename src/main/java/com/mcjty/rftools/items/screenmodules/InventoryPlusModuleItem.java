...
import com.mcjty.rftools.blocks.screens.modules.ItemStackPlusScreenModule;
...
import com.mcjty.rftools.blocks.screens.modulesclient.ItemStackPlusClientScreenModule;
...
public class InventoryPlusModuleItem extends Item implements ModuleProvider {
    ...
    public boolean onItemUse(ItemStack stack, EntityPlayer player, World world, int x, int y, int z, int side, float sx, float sy, float sz) {
        ...
        if (te instanceof IInventory) {
            ...
            if (world.isRemote) {
                RFTools.message(player, "Inventory module is set to block '" + name + "'");
            }
        } else {
            ...
            if (world.isRemote) {
                RFTools.message(player, "Inventory module is cleared");
            }
        }
