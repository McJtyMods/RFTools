...
import com.mcjty.rftools.blocks.logic.CounterTileEntity;
import com.mcjty.rftools.blocks.screens.ModuleProvider;
import com.mcjty.rftools.blocks.screens.modules.CounterPlusScreenModule;
...
import com.mcjty.rftools.blocks.screens.modulesclient.CounterPlusClientScreenModule;
...
public class CounterPlusModuleItem extends Item implements ModuleProvider {
    ...
    public void addInformation(ItemStack itemStack, EntityPlayer player, List list, boolean whatIsThis) {
        ...
        list.add(EnumChatFormatting.GREEN + "Uses " + CounterPlusScreenModule.RFPERTICK + " RF/tick");
    ...
    public boolean onItemUse(ItemStack stack, EntityPlayer player, World world, int x, int y, int z, int side, float sx, float sy, float sz) {
        ...
        if (te instanceof CounterTileEntity) {
            ...
            if (world.isRemote) {
                RFTools.message(player, "Counter module is set to block '" + name + "'");
            }
        } else {
            ...
            if (world.isRemote) {
                RFTools.message(player, "Counter module is cleared");
            }
        }
