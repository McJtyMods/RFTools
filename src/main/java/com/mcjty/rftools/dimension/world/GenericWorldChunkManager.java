...
//        List<BiomeManager.BiomeEntry> biomes = dimensionInformation.getBiomes();
//        if (biomes.isEmpty()) {
//            biomeGenBase = allowedBiomes.toArray(new BiomeGenBase[allowedBiomes.size()]);
//        } else {
//            biomeGenBase = new BiomeGenBase[biomes.size()];
//            int i = 0;
//            for (BiomeManager.BiomeEntry entry : biomes) {
//                biomeGenBase[i++] = entry.biome;
//            }
//        }
