...
public final class ModCrafting {
    ...
    public static void init() {
        ...
        GameRegistry.addRecipe(new ItemStack(ModBlocks.energyExtractorBlock), "RoR", "sMs", "RsR", 'o', Items.ender_pearl, 's', ModItems.dimensionalShard,
        ...
        GameRegistry.addRecipe(new ItemStack(ModBlocks.spawnerBlock), "rzr", "eMl", "rbr", 'M', ModBlocks.machineFrame, 'z', Items.rotten_flesh, 'e', Items.ender_pearl,
