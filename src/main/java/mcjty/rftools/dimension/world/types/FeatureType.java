...
public enum FeatureType {
    ...
    FEATURE_CAVES(new TSet(TERRAIN_AMPLIFIED, TERRAIN_CAVERN, TERRAIN_CAVERN_OLD, TERRAIN_FLOODED_CAVERN, TERRAIN_CHAOTIC, TERRAIN_FLAT, TERRAIN_ISLAND, TERRAIN_ISLANDS, TERRAIN_LOW_CAVERN, TERRAIN_NORMAL, TERRAIN_PLATEAUS, TERRAIN_NEARLANDS, TERRAIN_SOLID, TERRAIN_WAVES), null, 0, 0),
    FEATURE_RAVINES(new TSet(TERRAIN_AMPLIFIED, TERRAIN_CAVERN, TERRAIN_CAVERN_OLD, TERRAIN_FLOODED_CAVERN, TERRAIN_CHAOTIC, TERRAIN_FLAT, TERRAIN_ISLAND, TERRAIN_ISLANDS, TERRAIN_LOW_CAVERN, TERRAIN_NORMAL, TERRAIN_PLATEAUS, TERRAIN_NEARLANDS, TERRAIN_SOLID, TERRAIN_WAVES), null, 0, 0),
    FEATURE_ORBS(null, new MMap(-1, DimletType.DIMLET_MATERIAL), 1, 0),
    FEATURE_OREGEN(null, new MMap(-1, DimletType.DIMLET_MATERIAL), 0, 0),
    FEATURE_LAKES(new TSet(TERRAIN_AMPLIFIED, TERRAIN_CAVERN, TERRAIN_CAVERN_OLD, TERRAIN_CHAOTIC, TERRAIN_FLAT, TERRAIN_ISLAND, TERRAIN_ISLANDS, TERRAIN_LOW_CAVERN, TERRAIN_NORMAL, TERRAIN_PLATEAUS, TERRAIN_NEARLANDS, TERRAIN_SOLID, TERRAIN_WAVES), new MMap(-1, DimletType.DIMLET_LIQUID), 0, 0),
    ...
    FEATURE_DENSE_CAVES(new TSet(TERRAIN_AMPLIFIED, TERRAIN_CAVERN, TERRAIN_CAVERN_OLD, TERRAIN_FLOODED_CAVERN, TERRAIN_CHAOTIC, TERRAIN_FLAT, TERRAIN_ISLAND, TERRAIN_ISLANDS, TERRAIN_LOW_CAVERN, TERRAIN_NORMAL, TERRAIN_PLATEAUS, TERRAIN_NEARLANDS, TERRAIN_SOLID, TERRAIN_WAVES), null, 0, 0),
    ...
    FEATURE_PYRAMIDS(new TSet(TERRAIN_AMPLIFIED, TERRAIN_CAVERN, TERRAIN_CAVERN_OLD, TERRAIN_FLOODED_CAVERN, TERRAIN_FLAT, TERRAIN_CHAOTIC, TERRAIN_ISLAND, TERRAIN_ISLANDS, TERRAIN_LOW_CAVERN, TERRAIN_NEARLANDS, TERRAIN_NORMAL, TERRAIN_PLATEAUS, TERRAIN_SOLID, TERRAIN_WAVES),
