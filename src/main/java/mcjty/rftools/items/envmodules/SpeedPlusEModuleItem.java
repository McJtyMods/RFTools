...
public class SpeedPlusEModuleItem extends Item implements EnvModuleProvider {
    ...
    public SpeedPlusEModuleItem() {
        ...
        setRegistryName("speedplus_module");
    }

    @Override
    public void addInformation(ItemStack itemStack, World world, List<ITextComponent> list, ITooltipFlag flag) {
        super.addInformation(itemStack, world, list, flag);
        list.add(new StringTextComponent("This module gives speed III bonus when"));
        list.add(new StringTextComponent("used in the environmental controller."));
        list.add(new StringTextComponent(TextFormatting.GREEN + "Uses " + EnvironmentalConfiguration.SPEEDPLUS_RFPERTICK.get() + " RF/tick (per cubic block)"));
    }
