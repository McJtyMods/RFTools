...
//        NoTickShieldBlockTileEntity shieldBlockTileEntity = (NoTickShieldBlockTileEntity) world.getTileEntity(x, y, z);
...
//    }
//
//    private void renderShield(IBlockAccess world, int x, int y, int z, Block block, NoTickShieldBlockTileEntity shieldBlockTileEntity) {
