...
public class ModularStorageContainer extends GenericContainer {
    ...
    public static final ContainerFactory factory = new ContainerFactory() {
        ...
        protected void setup() {
            addSlotBox(new SlotDefinition(SlotType.SLOT_SPECIFICITEM, new ItemStack(ModItems.storageModuleItem)), CONTAINER_INVENTORY, SLOT_STORAGE_MODULE, 13, 160, 1, 18, 1, 18);
