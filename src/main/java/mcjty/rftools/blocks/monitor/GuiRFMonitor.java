...
public class GuiRFMonitor extends GenericGuiContainer<RFMonitorBlockTileEntity, GenericContainer> {
    ...
    public GuiRFMonitor(RFMonitorBlockTileEntity monitorBlockTileEntity, GenericContainer container, PlayerInventory inventory) {
        super(RFTools.instance, RFToolsMessages.INSTANCE, monitorBlockTileEntity, container, inventory, GuiProxy.GUI_MANUAL_MAIN, "monitor");
